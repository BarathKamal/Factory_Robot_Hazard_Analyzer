...
/*
Program that
1. Contains the already implemented Use Cases UC1 and UC2
2. Implements UC3 by calculating the Hazard Risk Factor and returning it through a calculateHazardRisk() method
without validation
 */
